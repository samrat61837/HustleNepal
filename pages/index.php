...
<div class="wrapper bgded overlay" style="background-image:url('../images/demo/backgrounds/pp1.jpg');">

  <div id="pageintro" class="hoc clear"> 
    <!--  -->
    <article>
      <h2 class="heading">Hustle Nepal</h2>
      <h3 class="heading3">बोल्न छोड् गर्न थाल</h3>
      <!-- <footer>
         <ul class="nospace inline pushright">
          <li><a class="btn" href="#"></a></li>
          <li><a class="btn inverse" href="#">Dumbass Mofo</a></li>
        </ul> 
      </footer> -->
    </article>
    <!-- inside photo -->
  ...
  <main class="hoc container clear"> 
    ...
    <section id="introblocks">
      <div class="sectiontitle">
        <h6 class="heading">Hustle was always a great thing to me</h6>
        <p>metus</p>
      </div>
      <ul class="nospace btmspace-80 group">
        <li class="one_quarter first"><pre>  </pre></li>
        <li class="one_third">
          <article><a href="gallery.php"><i class="fa fa-image"></i></a>
            <h6 class="heading font-x1"><a href="gallery.php">Quotes</a></h6>
            <p>Checkout some of our moitvating quotes&hellip;</p>
          </article>
        </li>
        <li class="one_third">
          <article><a href="articleList.php"><i class="fa fa-image"></i></a>
            <h6 class="heading font-x1"><a href="articleList.php">Blog</a></h6>
            <p>our bke bke blogs</p>
          </article>
        </li>
         <!-- <li class="one_third">
   ...
   <!--  <section>
      <div class="sectiontitle">
        <h6 class="heading">Inspiring quotes</h6>
        <p>HN inspires ble ble ble</p>
      </div>
      <ul class="nospace group overview">
        <li class="one_third">
          <figure><a href="#"><img src="../images/demo/hustle.png" alt=""></a>
            <figcaption>
              <h6 class="heading">any title here</h6>
              <p>That's our fucking logo mofo hehahaha</p>
            </figcaption>
          </figure>
        </li>
        <li class="one_third">
          <figure><a href="#"><img src="../images/demo/bg2.jpeg" alt=""></a>
            <figcaption>
              <h6 class="heading">similaar</h6>
  ...
  <section class="hoc container clear testimonials"> 
    ...
    <ul class="nospace group btmspace-80">
      ...
      <li class="one_third">
        ...
        <figure class="clear"><img class="circle" src="../images/demo/avatar.png" alt="">
          <figcaption>
            <h6 class="heading">Nishesh Maharjan</h6>
            <em>Hanuman</em></figcaption>
        </figure>
      </li>
    </ul>
...
<script src="../layout/scripts/jquery.gotodown.js"></script>
</body>
